        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            if (todayWeatherData != null) {
                withContext(Dispatchers.Main){
                    ...
                    else if(todayWeatherData?.wind?.deg!! >= 1 && todayWeatherData?.wind?.deg!! <= 89){
                    ...
                    else if(todayWeatherData?.wind?.deg!! >= 91 && todayWeatherData?.wind?.deg!! <= 179){
                    ...
                    else if(todayWeatherData?.wind?.deg!! >= 181 && todayWeatherData?.wind?.deg!! <= 269){
                    ...
                    else if(todayWeatherData?.wind?.deg!! == 271 && todayWeatherData?.wind?.deg!! <= 359){
                    ...
                    Log.d(SearchWeather::class.java.simpleName,todayWeatherData.toString())
                }
            }
        }
    }
